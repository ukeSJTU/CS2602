...
namespace datastructures
{
    ...
    public:
        ...
        void insert(int i, const elemType &e); // 在第i个位置插入新的元素（值为e），使原来的第i个元素成为第i+1个元素
        void remove(int i, elemType &e);       // 若第i个元素存在，删除并将其存入e指向的空间，使原来的第i+1个元素成为第i个元素
     ...
     */
    template <class elemType>
    SeqList<elemType>::~SeqList() { delete[] elem; }
