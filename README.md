...
本代码仓库对应上海交通大学 IEEE 专业 CS2602 课程。课程课本采用《数据结构 C++语言描述》慕课版。任课教师：张同珍老师。

# Brief

1. 课程笔记：`docs/`文件夹下按照章节整理知识点概念（目前尚未全部完成）；
2. 自定义容器：`include/`文件夹下是在课本代码的基础上实现的各种常用数据结构类，方便课后习题中使用；
3. 课本示例代码：`src/examples/`文件夹下包含书本上示例程序代码；
4. 课后作业代码：`src/homework/`文件夹下包含 ACM-OJ 作业题目代码；
5. 脚本工具：请参考[高效的自动化脚本](#高效的自动化脚本)
6. 其他：其他内容请参考[工程目录结构](#工程目录结构)说明
